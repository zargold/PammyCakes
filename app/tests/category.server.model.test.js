...
describe('Category API', function() {
    ...
    describe('authenticated create request with', function(done) {
        ...
        describe('name longer than 20 chars in length', function() {
            ...
            it('returns validation message', function() {
                response.body.message.should.equal('name must be 20 chars in length or less');
            });
        });
    ...
    describe('authenticated update request with', function() {
        ...
        describe('category name longer than 20 chars in length', function() {
